    ...
    return (
        <div>
            <div className='ml-16 text-center'>
                <h1 className="font-bold text-2xl text-[#FB6E09] mt-10">Added your food items:</h1>
            </div>

            <div className='ml-16 mb-20 mt-10'>
                                ...
                                users.map((item, index) => <tr key={item._id}>
                                    ...
                                    <th>
                                        {item.role === 'admin' ? 'Admin' : <span className='flex justify-center items-center'>
                                            <p onClick={() => handleMakeAdmin(item)} className='bg-[#FB6E09] p-2 rounded-lg'>
